...
;(assert (str.contains (str.at var2 var11) (str.at var2 var9)))
(assert (> (str.to.int var5) (str.to.int var1)))
;(assert (not (<= var9 var10)))
;(assert (str.suffixof (str.at "1Szfz|L-Si" var6) (str.at var0 3)))
;(assert (str.in.re (str.at var4 var11) (re.* re.allchar)))
